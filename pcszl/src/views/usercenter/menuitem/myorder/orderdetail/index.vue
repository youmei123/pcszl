  ...
  <div class="page-container">
    ...
    <div class="detail-cont content f-jb-as">
      <div class="detail-left">
        ...
        <div
          v-if="order.isEntity == 1 && (!aftersaleList.id || aftersaleList.refundStatus == 2 || (tabIndex != 5 && (aftersaleList.status == 3 || aftersaleList.status == 4)))">
        ...
        <div class="switch-bar f-je-ac">
          <div class="none-btn pointer" @click="toSubmit()">再买一单</div>
          ...
          <div class="color-btn pointer" @click="linkToRefundPage()"
            v-if="aftersaleList.refundStatus == 0 && tabIndex == 5">退款中</div>
          <div class="color-btn pointer" @click="linkToRefundPage()"
...
// 再买一单
const toSubmit = () => {//1:课程 2:VIP  6:经络vip  7：商品   8:百科VIP
  let name = ''
  let query = {}
  let type = order.value.orderType
  if (type == 1) {
    name = 'coursevideo'
    query = {
